...
| T30 | — | (planned) Continuous monitoring — `DiffPipeline` for change detection (`state.json`), `NotifyExtension` (console/JSONL/webhook), `--diff` flag, `monitor` subcommand, cron scheduling | I.crawl |
